...
routr.post("/categories/createCategory",
    authentication(),
...
routr.get(
    "/meals/getMealsByCategory/:categoryId",
...
routr.get("/categories/getAllCategories",
...
routr.get("/Cart/GetFlag", authentication(), GetFlag)
routr.get("/Item/itemID/:id", authentication(), itemID)


routr.post("/FAQ/createFAQ", authentication(), createFAQ)

routr.post("/Order/CreateCustomerOrder", authentication(), CreateCustomerOrder)

routr.get("/Order/GetCustomerOrders", authentication(), GetCustomerOrders)

routr.get("/Item/ItemsByBranchAndCategory/:branchID/:categoryID", authentication(), ItemsByBranchAndCategory)



routr.get("/Order/GetCustomerOrder", authentication(), GetCustomerOrder)
routr.get("/Offer/GetAllOffer/:branchId", authentication(), GetAllOffer)

routr.get("/Offer/GetOfferById/:branchId", authentication(), GetOfferById)


routr.get("/Item/PopularItems/:branchId", authentication(), PopularItems)

routr.get("/FAQ/getAllFAQs", authentication(), getAllFAQs)
routr.get("/Account/GetAddresses",authentication() ,GetUserAddress)


routr.get("/Account/getAccountInfo", authentication(), getAccountInfo)



routr.get("/Category/getCategoriesWithItemsByBranch/:branchId", authentication(), getCategoriesWithItemsByBranch)
...
routr.post("/Account/AddAddress", authentication(), AddAddress)

routr.get("/Category/bybranch/:branchId", authentication(), getCategoriesByBranchStatic)

routr.put("/Account/UpdateAddress", authentication(), UpdateUserAddress)



routr.put("/Account/updateAccountInfo", authentication(), updateAccountInfo)



routr.post("/Extra/createExtra", authentication(), createExtra)


routr.post("/Attribute/createAttribute", authentication(), createAttribute)

routr.post("/Addon/createAddon", authentication(), createAddon)
routr.post("/confirmPhoneOtp", confirmPhoneOtp)
routr.get("/Branch/getAllBranches", getAllBranches)
