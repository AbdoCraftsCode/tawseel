...
routr.get("/Address/GetUserAddress", GetUserAddress)
...
routr.post("/Address/AddAddressToUser", authentication(), AddAddressToUser)


routr.put("/Address/UpdateUserAddress", authentication(), UpdateUserAddress)
